...
| Set Up the Dynamics NAV Connector |Sets up a connection to Dynamics 365 for Sales, which allows you to synchronize data such as contacts and sales order information. |
...
Each time you sign in during the trial period, a notification in a blue bar at the top displays the time remaining. If you decide to subscribe, use the link in the notification to get in touch with Microsoft. You can also contact the [!INCLUDE[d365fin](includes/d365fin_md.md)] Sales team at [Microsoft Dynamics NAV](https://go.microsoft.com/fwlink/?linkid=828707).  

## <a name="other-dynamics-nav-apps"></a>Other Dynamics NAV apps
Navigate to content about the other Dynamics NAV apps by choosing the [Dynamics NAV](https://docs.microsoft.com/dynamics365) link in the blue banner at the top of this page. You can also learn more at the [Dynamics NAV website](https://www.microsoft.com/en-us/dynamics365/).
...
[Microsoft Dynamics NAV documentation](https://docs.microsoft.com/en-us/dynamics365/#pivot=solutions&panel=solutions_financials)  
