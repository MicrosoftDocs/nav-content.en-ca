...
|Use an EU web service to verify a customer's GST/HST Registration number.|[How to: Verify GST/HST Registration numbers](sales-how-to-verify-vat-registration-numbers.md)|
