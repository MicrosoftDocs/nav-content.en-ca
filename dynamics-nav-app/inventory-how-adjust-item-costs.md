...
### <a name="costing-method-fifo-lifo-specific-or-average"></a>Costing Method FIFO, LIFO, Specific, or Average  
 [!INCLUDE[d365fin](includes/d365fin_md.md)] calculates the contents of the **Unit Cost ($)** field on the purchase line or the contents of the **Unit Cost** field on the item journal line according to the following formula:  
