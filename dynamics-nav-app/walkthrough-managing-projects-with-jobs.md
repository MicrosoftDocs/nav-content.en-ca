...
6.  On the **Foreign Trade** FastTab, set the currency code to **CAD**. If you select CAD in the **Invoice Currency Code** field, then the job will be invoiced in CA dollars and planned in the local currency of CRONUS only.  
