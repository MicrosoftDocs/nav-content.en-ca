...
---
# <a name="managing-your-customer-relationships-using-dynamics-365-for-sales-from-inside-dynamics-nav"></a>Managing Your Customer Relationships using Dynamics 365 for Sales from inside Dynamics NAV
