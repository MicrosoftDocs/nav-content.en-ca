...
9. Choose the **OK** button to copy the lines to the new document.  
    ...
    -   Calculates the **Unit Cost ($)** field on the new line from the costs on the corresponding item ledger entries.  
