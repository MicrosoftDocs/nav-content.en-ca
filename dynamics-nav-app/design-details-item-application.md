...
1. In entry number 1, the user posts a purchase at a cost of $ 10.00.  
2. In entry number 2, the user posts a purchase at a cost of $ 20.00.  
...
Because a fixed application is made from the purchase return to the second purchase entry, the items are returned at the correct cost. If the user had not performed the fixed application, then the returned item would be incorrectly valued at $ 10.00 because the return would have been applied to the first purchase entry according to the FIFO principle.  
...
The cost of the second purchase, $ 20.00, is passed correctly to the purchase return.  
...
1. In entry numbers 1 and 2, the user posts two purchase invoices. The second invoice has the incorrect direct unit cost of $ 1000.00.  
...
3. In entry number 4, the user posts another purchase invoice with the correct direct unit cost of $ 100.00  
...
1. The user purchases the item at a cost of $ 10.00.  
2. The user purchases the item again at a cost of $ 20.00.  
...
1. The user purchases the item at a standard cost of $ 10.00.  
2. The user transfers the item from BLUE to RED location at a standard cost of $ 12.00.  
...
Since the value of the original inventory increase is $ 10.00, the transfer is valued at that cost, not at $ 12.00.  
