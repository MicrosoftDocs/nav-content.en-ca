...
### [Users, Profiles, and Role Centres](admin-users-profiles-roles.md)
...
### [How to: Verify GST/HST Registration numbers](sales-how-to-verify-vat-registration-numbers.md)
...
### [How to: Work with Responsibility Centres](inventory-responsibility-centers.md)
...
### [Inviting Your External Accountant to Your Dynamics NAV](finance-invite-external-accountant.md)  
...
## [Managing Your Customer Relationships Using Dynamics 365 for Sales from Inside Dynamics NAV](marketing-integrate-dynamicscrm.md)
...
## [How to: View the Load in Work and Machine Centres](production-how-to-view-the-load-on-work-centers.md)
