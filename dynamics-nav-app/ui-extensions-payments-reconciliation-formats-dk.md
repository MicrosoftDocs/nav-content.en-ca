...
# <a name="the-payments-and-reconciliations-dk-extension-for-microsoft-dynamics-for-finance-and-operations-business-edition"></a>The Payments and Reconciliations (DK) Extension for Microsoft Dynamics for Finance and Operations, Business edition
...
### <a name="to-allow-included365finincludesd365finmdmd-to-export-payment-data"></a>To allow [!INCLUDE[d365fin](includes/d365fin_md.md)] to export payment data
