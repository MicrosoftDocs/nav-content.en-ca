...
|Cost centre|Cost centres are most often departments and profit centres that are largely responsible for company’s costs and income. Cost centres can be synchronized with dimensions in the general ledger. It is also possible to add new cost centres and define their own sorting with subtotals.|  
