...
|Recipient Postal/ZIP Code|Postal/ZIP Code|Customer/Vendor|The recipient postal/ZIP code that is specified on the customer or vendor card|  
...
|Recipient Bank Postal/ZIP Code|Postal/ZIP Code|Customer Bank Account/Vendor Bank Account|The recipient bank account postal/ZIP code that is specified on the customer or vendor bank account card|  
...
|Sender Bank Postal/ZIP Code|Postal/ZIP Code|Bank Account|The sender bank account postal/ZIP code that is specified on the bank account card|  
