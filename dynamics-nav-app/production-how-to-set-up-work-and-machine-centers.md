...
4.  In the **Work Centre Group** field, select the higher-level resource grouping that the work centre is organized under, if relevant. Choose the **New** action in the drop-down list.  
